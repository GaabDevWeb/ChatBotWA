...
- **Migração para Baileys** - Biblioteca mais estável e atualizada para WhatsApp
...
- **Sistema de Eventos Avançado** - Melhor gerenciamento de callbacks e eventos
...
Este projeto foi migrado do `venom-bot` para `@whiskeysockets/baileys` para melhor estabilidade e suporte. As principais mudanças incluem:

### **Novas Dependências**
- `@whiskeysockets/baileys` - Biblioteca principal do WhatsApp
- `@hapi/boom` - Tratamento de erros
- `qrcode-terminal` - Exibição do QR Code
- `pino` - Sistema de logging

### **Autenticação**
- Autenticação multi-arquivo para melhor segurança
- QR Code gerado automaticamente no terminal
- Reconexão automática em caso de desconexão

### **Compatibilidade**
- Todas as funcionalidades do `venom-bot` foram mantidas
- Sistema de eventos compatível com callbacks existentes
- Plugins atualizados para nova estrutura de mensagens
